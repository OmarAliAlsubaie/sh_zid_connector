...
class AutoSaleWorkflow(models.Model):
    ...
    zid_order_state=fields.Selection([('new','New'),('preparing','Preparation in Progress'),('ready','Ready'),('indelivery','Delivery in Progress'),('delivered','Delivered'),('cancelled','Cancelled')],string="Zid Order State",required=True)
